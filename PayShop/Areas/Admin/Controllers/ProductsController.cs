...
namespace PayShop.Areas.Admin.Controllers
{
    [Authorize(Roles = "admin")]
    [Area("Admin")]
    public class ProductsController : Controller
    {
        private readonly PayShopContext context;
        private readonly IWebHostEnvironment webHostEnvironment;


        public ProductsController(PayShopContext context, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public async Task<IActionResult> Index(int p = 1)//
        {
            ...
            ViewBag.PageNumber = p;//hien thi so trang
        ...
        public async Task<IActionResult> Create(Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (slug != null)
                {
                    ModelState.AddModelError("", "Sản phẩm đã tồn tại.");
                    return View(product);
                }
                ...
                TempData["Success"] = "Sản phẩm đã được thêm!";
        ...
        public async Task<IActionResult> Edit(int id, Product product)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                TempData["Success"] = "Sản phẩm đã được sửa";
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            else
            {
                ...
                TempData["Success"] = "Sản phẩm đã được xóa";
            }
